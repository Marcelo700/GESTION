...
class AdminModel extends Query
{
    ...
    {
        $sql = "SELECT * FROM carpetas WHERE id_usuario = $id_usuario AND estado = 1 AND id != 1 ORDER BY id DESC LIMIT 4";
    ...
    public function subirArchivos($name, $tipo, $id_carpeta, $id_usuario)
    {
    ...
    {
        $sql= "SELECT d.id, d.correo, d.estado, d.elimina, a.nombre FROM detalle_archivos d INNER JOIN archivos 
